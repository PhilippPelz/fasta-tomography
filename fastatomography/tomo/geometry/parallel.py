...
from fastatomography.tomo.geometry import Flat1dDetector, Flat2dDetector
from fastatomography.tomo.geometry import Geometry, AxisOrientedGeometry
...
class Parallel3dEulerGeometry(ParallelBeamGeometry):
    ...
    def partition(self):
        ...
        """
        # m = tuple(np.prod(np.array(self.motion_partition)))
