...
% STEM fits
NsubPxIter  = 1;         % Outer loop fitting iterations.
rCut        = 6;               % Cutting radius (to speed up fits).
rFit        = 5;               % fitting radius in pixels.
xyzStep     = 0.25;           % maximum change in x/y per iteration.
f_plot      = 1;             % To plot as you go, set to "true" or 1 (for tuning)
sigmaRange  = [3 7];  % Max and min sigma values IN PIXELS
...
bgRange     = [0 1e-3];  % background range
