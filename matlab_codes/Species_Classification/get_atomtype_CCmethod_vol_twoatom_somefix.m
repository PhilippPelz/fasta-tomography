function [atomtype] =get_atomtype_CCmethod_vol_twoatom_somefix(DataMatrix, atom_pos, avatomFe, avatomPt, boxhalfsize, atomtype, fixind)

%atomtype = zeros(1,size(atom_pos,2));

iterarr = 1:size(atom_pos,2);
iterarr(fixind ) = [];
